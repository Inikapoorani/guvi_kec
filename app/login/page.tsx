      ...
      <div className="min-h-screen bg-gradient-to-br from-secondary to-background flex items-center justify-center px-4">
        <div className="bg-card rounded-lg shadow-lg p-8 max-w-md w-full text-center border border-border">
          ...
          <p className="text-muted-foreground mb-6">
            Welcome back to the KEC × GUVI DevOps Program
          </p>
          <Link href="/">
        ...
        <div className="bg-card rounded-lg shadow-lg p-8 border border-border">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">
              Sign in to your KEC × GUVI account
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <a href="#" className="text-sm text-accent hover:text-accent/90 font-medium">
                Forgot password?
              </a>
            </div>
          ...
          <div className="space-y-2">
            <Button
              variant="outline"
              className="w-full border-border text-card-foreground hover:bg-secondary bg-transparent"
            >
